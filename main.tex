...
%        \include{chapter/11_grundlagen}
%        \include{chapter/02_projektumfeld}
%        \include{chapter/03_analyse}
%        \include{chapter/04_entwurf}
%        \include{chapter/05_implementierung}
%        \include{chapter/06_test}
%        \include{chapter/07_fazit_ausblick}
%        \include{chapter/08_anhang}

    \end{onehalfspacing}

%    \include{chapter/09_verzeichnisse}
%    \glsaddall
%    \printglossaries
