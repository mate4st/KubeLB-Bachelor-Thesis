...
\usepackage[left=1.5cm, right=3.0cm, bottom=3.5cm]{geometry}
\usepackage{float}
...
\begin{document}
    ...
    \begin{onehalfspacing}
        ...
        \include{chapter/09_limitations}
        \include{chapter/10_conclusion}
        \include{chapter/11_one_step_further}

    \end{onehalfspacing}

    \include{chapter/12_directories}
%    \glsaddall
%    \printglossaries
